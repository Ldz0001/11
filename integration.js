(function(global){
  ...
  function scopedRevenueSnapshot(){
    ...
    let paymentReceived=0, pendingReceipt=0;
    scoped.forEach(ctx=>{
      const ev = ctx.event || {};
      ...
      pendingReceipt += Number(totals.pendingReceipt || 0) || 0;
    ...
    return { revenue: revenueActual, revenuePlanned, cost: costActual, profit, marginPct, costPerGuest, hasEvents:true, paymentReceived, pendingReceipt };
  }
